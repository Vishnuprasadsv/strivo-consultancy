              ...
              <div className="sticky top-28 h-fit flex flex-col gap-8">
                ...
                <div className="bg-main rounded-[var(--radius-sm)] p-6">
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <button onClick={handleCopyLink} className="w-10 h-10 rounded-full bg-[#1F2937] flex items-center justify-center text-white hover:text-white hover:bg-[var(--color-primary-hover)] transition-colors" aria-label="Copy Link">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"></path></svg>
                    </button>
                    <a href={`mailto:?subject=${encodeURIComponent(article.title)}&body=${encodeURIComponent(window.location.href)}`} className="w-10 h-10 rounded-full bg-[#1F2937] flex items-center justify-center text-white hover:text-white hover:bg-[var(--color-primary-hover)] transition-colors" aria-label="Email Article">
