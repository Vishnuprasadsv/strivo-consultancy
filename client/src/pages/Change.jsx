  ...
  return (
    <div className="bg-main w-full py-8 md:py-16 min-h-screen font-sans">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-8 md:py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <h1 className="main-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight mb-6">Change Management</h1>
      ...
      <motion.section
        ...
        viewport={{ once: true, amount: 0.1 }}
        variants={fadeUpVariants}
        className="w-full bg-sub py-16 md:py-24 border-y border-[var(--color-border-color)]"
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-stretch">
            <div className="bg-[#111111] border border-[#222222] rounded-[var(--radius-sm)] p-8 flex flex-col justify-between">
              <div>
                ...
                <p className="paragraph text-white mb-4"><strong>Challenge:</strong> A multinational firm was struggling to get teams aligned on a major enterprise transformation, leaving adoption stalled and productivity under pressure.</p>
                <p className="paragraph text-white mb-8"><strong>Solution:</strong> We activated a leadership alignment program, a role-based communication plan, and behavior reinforcement rituals that accelerated adoption and freed critical teams to deliver value faster.</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="bg-[#111111] border border-[#222222] rounded-[var(--radius-sm)] p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl mx-auto space-y-6">
              <h2 className="sub-heading text-white">Ready to Lead Organizational Change Successfully?</h2>
