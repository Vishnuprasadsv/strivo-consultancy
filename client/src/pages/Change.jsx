  ...
  return (
    <div className="w-full bg-sub">
      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        {/* 2. INTRO: Leading Organizational Change */}
        ...
        {/* 3. SERVICE OVERVIEW */}
        <div className="px-4 md:px-12 lg:px-[180px]">
          <motion.section
          ...
          >
            ...
            <div className="flex flex-col items-center text-center mb-12 w-full">
              ...
              <h2 className="sub-heading text-center">Change Management Services</h2>
            </div>
                ...
                <Box sx={{ position: "relative", width: "100%", maxWidth: { xs: "100%", md: "520px", lg: "600px" }, mx: "auto" }}>
                  ...
                  <Box
                    sx={{
                      ...
                      width: "80%",
                      height: "80%",
                      background: "radial-gradient(circle, var(--color-primary) 35%, transparent 100%)",
                      borderRadius: "3px",
                      zIndex: 0,
                    }}
                  />
        ...
        {/* 5. STRATEGIC FRAMEWORK METHODOLOGY */}
        ...
        >
          <div className="w-full px-4 sm:px-6 lg:px-8">
            <Box sx={{ textAlign: "center", mb: 6 }}>
              <Box component="p" className="pre-heading" sx={{ textTransform: "uppercase", mb: 1.5 }}>
                Proven Results
              </Box>
              <Box component="h2" className="sub-heading" sx={{ color: "var(--color-primary)", mb: 2 }}>
                Our Impact Metrics
              </Box>
            </Box>
              ...
              {impactMetrics.map((metric, index) => (
                ...
                >
                  ...
                  <Box sx={{ display: "flex", alignItems: "baseline", mb: 0.5 }}>
                    <Box sx={{ color: "#fff", fontSize: "2.8rem", fontWeight: 700, lineHeight: 1 }}>
                  ...
                  <Box sx={{ color: "rgba(255,255,255,0.7)", fontSize: "0.8rem", fontWeight: 600, letterSpacing: "1px", textTransform: "uppercase" }}>
                    {metric.label}
                  </Box>
                </Box>
              ))}
        ...
        {/* 7. STRATEGIC EXCELLENCE IN ACTION (CASE STUDY) */}
        <div className="px-4 md:px-12 lg:px-[180px]">
          <motion.section
            initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} variants={fadeUpVariants}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-stretch">
              <div className="bg-main rounded-[var(--radius-sm)] p-8 flex flex-col justify-between">
                ...
                >
                  ...
                  <ArrowForwardIcon sx={{ fontSize: 18, transition: "transform 0.3s ease" }} className="group-hover:translate-x-1" />
                </Link>
              </div>
              ...
              <div className="bg-main rounded-[var(--radius-sm)] p-8 flex flex-col items-center justify-center min-h-[400px] relative overflow-hidden">
                ...
                <div className="w-full h-full flex items-end justify-between gap-2 px-4 relative z-0 opacity-50">
                  ...
                  <div className="w-1/6 bg-gradient-to-t from-[var(--color-primary)] to-[var(--color-primary-hover)] h-[70%] rounded-t-sm "></div>
                  <div className="w-1/6 bg-gradient-to-t from-[var(--color-primary)] to-[var(--color-primary-hover)] h-[90%] rounded-t-sm "></div>
                </div>
