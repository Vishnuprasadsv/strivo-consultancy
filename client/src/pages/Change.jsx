      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative w-full aspect-square md:aspect-auto md:h-[600px] rounded-2xl overflow-hidden bg-[#111111] border border-[#222222] flex items-center justify-center p-8">
            <img alt="Change management, leadership, workforce transformation, organizational alignment" className="object-contain w-full h-full opacity-90 drop-shadow-[0_0_30px_rgba(37,99,235,0.2)]" src={changeManagement}/>
          </div>
        </div>
        </div>
      </motion.section>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2 space-y-8">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-pure-black">Change Management Services</h2>
