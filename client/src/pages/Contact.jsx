...
const Contact = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen font-sans overflow-hidden bg-main">
      ...
      {/* Section 1: Hero - Fluid spacing matched layout */}
      <Box
      ...
      {/* Wrapper for Sections 2+ - Matched responsive margins layout */}
        ...
        <div className="max-w-[1440px] mx-auto space-y-20">
          ...
          >
            ...
            <div className="space-y-4 w-full">
              ...
              <div className="bg-[var(--color-sub-bg)] rounded-[var(--radius-sm)] border border-gray-200 overflow-hidden h-64 w-full">
                <iframe
            ...
            {/* Right Column: Form */}
            <div className="bg-[var(--color-sub-bg)] p-6 sm:p-8 rounded-[var(--radius-sm)] w-full border border-gray-200">
