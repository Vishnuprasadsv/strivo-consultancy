      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-12">
        ...
        >
          <div className="p-8 md:p-10 flex flex-col justify-center h-full order-2 lg:order-1">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-[var(--color-pure-black)] mb-4">
        ...
        >
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-[var(--color-pure-black)] mb-3">
              {currentContent.pillarsTitle}
            </h2>
            <p className="text-[var(--color-pure-black)] text-sm md:text-base">
            ...
            {currentContent.pillars.map((pillar) => (
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-grow relative z-20 bg-gradient-to-br from-[var(--color-main-bg)]/50 to-[var(--color-sub-bg)]/50">
                  <span className="text-blue-500 text-xs font-semibold mb-2 uppercase">
                    {pillar.category}
                  </span>
                  <h3 className="text-lg md:text-xl font-bold text-[var(--color-pure-black)] mb-2">
                    {pillar.title}
                  </h3>
                  <p className="text-[var(--color-pure-black)] text-xs md:text-sm leading-relaxed flex-grow">
                    {pillar.description}
                  </p>
                </div>
              </motion.article>
