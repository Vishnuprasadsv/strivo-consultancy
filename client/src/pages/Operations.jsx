...
const Operations = () => {
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-6 md:px-12 py-8 md:py-12">
      ...
      {/* Section 4: Operations Methodology */}
      <motion.section
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.1 }}
