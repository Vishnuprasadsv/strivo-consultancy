  ...
  return (
    <div className="w-full bg-sub">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2 space-y-8">
              ...
              <h2 className="sub-heading">Precision in Every Process</h2>
        ...
        >
          <div className="bg-main var(--radius-sm) p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl mx-auto space-y-6">
              <h2 className="sub-heading">Ready to Transform Operational Performance?</h2>
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-12 lg:px-[180px]">
        ...
        >
          <div className="mb-12">
            <h2 className="sub-heading">Operations Pillars</h2>
          </div>
  ...
  <div className="max-w-[1440px] mx-auto px-4 md:px-12 lg:px-[180px]">
    ...
    >
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-12 lg:px-[180px]">
        ...
        >
          <div>
            <h2 className="sub-heading mb-6">What Could Operational Efficiency Unlock For Your Business?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-stretch">
            <div className="bg-main rounded-[var(--radius-sm)] p-8 flex flex-col justify-between">
              <div>
                ...
                <p className="paragraph mb-8"><strong>Solution:</strong> We restructured the core logistics framework, implementing automated tracking and predictive inventory management to drastically reduce bottlenecks.</p>
              </div>
