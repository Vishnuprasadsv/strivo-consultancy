        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 relative w-full aspect-square md:aspect-auto md:h-[500px] rounded-2xl overflow-hidden flex items-center justify-center p-8">
              <img alt="Digital transformation workflow visualization" className="object-contain w-full h-full opacity-90 drop-shadow-[0_0_30px_rgba(37,99,235,0.2)]" src={digitalTransformationServices} />
            </div>
        ...
        >
          <div className="bg-main var(--radius-sm) p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl mx-auto space-y-6">
              <h2 className="sub-heading">Ready to Accelerate Digital Transformation?</h2>
            ...
            <div className="bg-main rounded-[var(--radius-sm)] p-8 flex flex-col justify-between">
              <div>
                <div className="flex gap-2 mb-6">
                  <span className="px-3 py-1 rounded-full bg-[var(--color-primary)] border border-[#374151] text-xs font-semibold text-white">Digital</span>
