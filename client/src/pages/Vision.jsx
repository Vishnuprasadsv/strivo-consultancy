      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-12">
        ...
        >
          <div className="p-8 md:p-10 flex flex-col justify-center h-full order-2 lg:order-1">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-[var(--color-pure-black)] mb-4">Shaping the Corporate Landscape of Tomorrow</h2>
        ...
        >
          <div className="mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-[var(--color-pure-black)] mb-3">Our Vision Pillars</h2>
            <p className="text-[var(--color-pure-black)] text-sm md:text-base">The key coordinates that guide our long-term trajectory and global objectives.</p>
          </div>
