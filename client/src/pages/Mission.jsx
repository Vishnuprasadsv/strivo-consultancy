    ...
    <div className="min-h-screen bg-transparent text-white font-sans">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          >
            <div className="p-8 md:p-10 flex flex-col justify-center h-full order-2 lg:order-1">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-[var(--color-black)] mb-4">Empowering Enterprises for the Future</h2>
      ...
      <div className="bg-[var(--color-sub-bg)] py-16 md:py-24 text-[var(--color-black)]">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          >
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-[var(--color-black)] mb-3">Our Core Pillars</h2>
              <p className="text-gray-600 text-sm md:text-base">The methodologies and principles that direct our client delivery model.</p>
            </div>
