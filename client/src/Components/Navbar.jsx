      ...
      >
        <div className="max-w-7xl mx-auto px-8 flex items-center justify-between h-20">
          ...
          <motion.div variants={itemVariants} className="flex items-center gap-4">
            <button className="cursor-pointer px-5 py-2 bg-black border border-blue-600 text-white rounded-full hover:bg-blue-900/30 transition-colors text-sm font-medium shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_20px_rgba(37,99,235,0.5)]">
              Get Started
            </button>
          </motion.div>
        </div>
          ...
          >
            <ul className="flex flex-col p-4 gap-2">
              ...
              <div className=" border-t border-gray-800 mt-2 pt-4 flex flex-col gap-3">
                <button className="cursor-pointer w-full px-4 py-3 bg-black text-white rounded-full border border-blue-600 shadow-[0_0_15px_rgba(37,99,235,0.3)] text-sm font-medium">
                  Get Started
                </button>
              </div>
            </ul>
